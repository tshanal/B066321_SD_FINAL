...
class unitTest:
    ...
    # Tau_mat is genrated after resetting the graph.reset_tau()	and checked for the intented outpuy		
    ...
    # This will test the Biggroup and work as this test make sure the algorithm is 					 
	...
	# Random behavior is also genrated by the work variable Q0 this is problitity which decided the path ant will take 
        # This is set to 0 to test frist path and set to 99 to test the other path.	 
